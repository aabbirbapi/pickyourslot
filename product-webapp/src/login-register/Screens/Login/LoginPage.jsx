...
export default function LoginPage(props) {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { setShow }) => {
      ...
      axios
        .post("https://18.222.217.10:8080/authenticationservice/api/v1/login", {
        ...
        .then((resp) => {
          if (resp.data.JWT_Token !== null) {
            ...
            if (decodedToken.UserRole.localeCompare("TAG_TEAM_MEMBER") == 0) {
              ...
              axios.get(`https://18.222.217.10:8080/userservice/api/v1/tagTeam/${decodedToken.EmailID}`)
              .then((response)=>{
              ...
              axios.get(`https://18.222.217.10:8080/userservice/api/v1/interviewer/${decodedToken.EmailID}`)
              .then((response)=>{
