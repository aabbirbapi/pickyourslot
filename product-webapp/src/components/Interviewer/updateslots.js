...
function UpdateSlot()
{
    ...
    const response = await fetch(`http://18.222.217.10:8080//interviewerservice/api/v1/${emailId}`);
    ...
    function Addslot(props)
    {
            ...
            const addSlottoserver = () =>{
                ...
                axios.post('http://18.222.217.10:8080//interviewerservice/api/v1/newSlot', newSlot)
...
{
    console.log(props);
    axios.delete(`http://18.222.217.10:8080//interviewerservice/api/v1/${props}`).then((res)=> {
            console.log(res);
    })
