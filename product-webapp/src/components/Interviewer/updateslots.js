...
function UpdateSlot()
{
    ...
    const response = await fetch(`https://18.222.217.10:8080/interviewerservice/api/v1/${emailId}`);
    ...
    function Addslot(props)
    {
            ...
            const addSlottoserver = () =>{
                ...
                axios.post('https://18.222.217.10:8080/interviewerservice/api/v1/newSlot', newSlot)
...
{
    console.log(props);
    axios.delete(`https://18.222.217.10:8080/interviewerservice/api/v1/${props}`).then((res)=> {
            console.log(res);
    })
