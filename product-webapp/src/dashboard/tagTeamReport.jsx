...
export default function TagTeamReport(props) {
    ...
    useEffect(() => {
        ...
        axios
            .get(`https://18.222.217.10:8080/interviewerservice/api/v1/interviewer/${year}/${month}`)
            .then((resp) => {
            ...
            axios
            .get(`https://18.222.217.10:8080/tagservice/api/v1/tag/${year}/${month}/${tagTeamName}`)
            .then((resp) => {
    ...
    function handleSubmit(event) {
        ...
        axios
            .get(
                `https://18.222.217.10:8080/interviewerservice/api/v1/interviewer/${year}/${month}`
            )
            .then((resp) => {
                if (resp.alllist > 0) {
                    setSlotsProvided(resp.data.alllist);
